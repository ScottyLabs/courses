//! OIDC authentication: group claims on the session drive authorization, and
//! the `CurrentUser` extractor turns a valid session into an authenticated
//! principal (or a `401`).
...
/// Group paths that authorize catalog access
